    ...
    def _build_model_optimizer(
        ...
        with init_context(), warnings.catch_warnings():
            ...
            for name, module in actor_module.named_modules():
                setattr(module, "_hook_name", name)
        ...
        if role == "actor" and optim_config is not None:
            ...
            # norm_params = [
            #    p for n, p in actor_module.named_parameters() if "norm" in n.lower()
            # ]
            # other_params = [
            #    p for n, p in actor_module.named_parameters() if "norm" not in n.lower()
            # ]
            # adam_params = [
            #    dict(params=norm_params, lr=optim_config.norm_lr),
            #    dict(params=other_params, lr=optim_config.lr),
            # ]
