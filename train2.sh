...
export DUMP_DIR=dumps/${MODEL_PATH}/${CHECKPOINTS_DIR}
mkdir -p ${DUMP_DIR}
...
python3 -m verl.trainer.main_ppo \
 ...
 +actor_rollout_ref.rollout.inv_conj=True \
 ...
 trainer.total_training_steps=100 2>&1 | tee verl_demo.log
